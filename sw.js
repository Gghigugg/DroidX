const CACHE='droidx-v3';
const ASSETS=['./','./index.html','./style.css','./premium.css','./script.js','./global-search.js','./command-center.js','./splash.js','./touch-engine.js','./compatibility-engine.js','./manifest.webmanifest','./icon-192.svg','./icon-512.svg'];
