const CACHE='droidx-v2';
const ASSETS=['./','./index.html','./style.css','./premium.css','./script.js','./global-search.js','./command-center.js','./splash.js','./touch-engine.js','./compatibility-engine.js','./manifest.webmanifest'];
